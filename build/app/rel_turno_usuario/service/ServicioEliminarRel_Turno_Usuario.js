...
class ServicioEliminarRel_Turno_Usuario {
    static EliminarTurnoUsuario(obj, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield dbConnetions_1.default.task((consulta) => {
                return consulta.result(Sql_Rel_Turno_Usuario_1.sql_rel_turno_usuario.DELETE, [obj.CodTurnoUsuario]);
            }).then((respuesta) => {
...
exports.default = ServicioEliminarRel_Turno_Usuario;
