...
-- set table ownership
alter table accesos owner to user_parqueadero
;
/*==============================================================*/
/* Index: indice_correo                                         */
/*==============================================================*/
...
-- set table ownership
alter table funcionalidades owner to user_parqueadero
;
/*==============================================================*/
/* Table: ingresos                                              */
/*==============================================================*/
...
-- set table ownership
alter table ingresos owner to user_parqueadero
;
/*==============================================================*/
...
-- set table ownership
alter table ingresos_servicios_otros owner to user_parqueadero
;
/*==============================================================*/
/* Table: parqueaderos                                          */
/*==============================================================*/
...
-- set table ownership
alter table parqueaderos owner to user_parqueadero
;
/*==============================================================*/
/* Table: puestos                                               */
/*==============================================================*/
...
-- set table ownership
alter table puestos owner to user_parqueadero
;
/*==============================================================*/
...
-- set table ownership
alter table rel_rol_funcionalidad owner to user_parqueadero
;
/*==============================================================*/
...
-- set table ownership
alter table rel_turno_usuario owner to user_parqueadero
;
/*==============================================================*/
...
-- set table ownership
alter table rel_usuario_funcionalidad owner to user_parqueadero
;
/*==============================================================*/
/* Table: roles                                                 */
/*==============================================================*/
...
-- set table ownership
alter table roles owner to user_parqueadero
;
/*==============================================================*/
/* Index: indice_nomrol                                         */
/*==============================================================*/
...
-- set table ownership
alter table servicios_diarios owner to user_parqueadero
;
/*==============================================================*/
...
-- set table ownership
alter table servicios_otros owner to user_parqueadero
;
/*==============================================================*/
/* Table: tarifa_diaria                                         */
/*==============================================================*/
...
-- set table ownership
alter table tarifa_diaria owner to user_parqueadero
;
/*==============================================================*/
...
-- set table ownership
alter table tipos_vehiculos owner to user_parqueadero
;
/*==============================================================*/
/* Table: turnos                                                */
/*==============================================================*/
...
-- set table ownership
alter table turnos owner to user_parqueadero
;
/*==============================================================*/
/* Table: ubicaciones                                           */
/*==============================================================*/
...
-- set table ownership
alter table ubicaciones owner to user_parqueadero
;
/*==============================================================*/
/* Table: usuarios                                              */
/*==============================================================*/
...
-- set table ownership
alter table usuarios owner to user_parqueadero
;
/*==============================================================*/
...
-- set table ownership
alter table vehiculos owner to user_parqueadero
;
alter table accesos
